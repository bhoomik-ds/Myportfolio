...
// Standard SVG paths for common social icons
const ICONS = {
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6 sm:mb-0">
            <img 
              src={logo} 
              alt="Bhoomik Logo" 
              className="w-12 h-12 object-contain drop-shadow-[0_0_15px_rgba(124,58,237,0.5)]" 
            />
            <div className="flex flex-col">
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-[#a78bfa] tracking-tight">
                Bhoomik Developer
              </span>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <SocialIcon path={ICONS.linkedin} delay={0.2} href="https://www.linkedin.com/in/bhoomik-sorathiya-digitalmarketerandfullstackdevloper/" />
            <SocialIcon path={ICONS.github} delay={0.1} href="https://github.com/bhoomik-ds" />
            <SocialIcon path={ICONS.instagram} delay={0.4} href="https://www.instagram.com/i_bhoomiksorthiya?igsh=MTc3aHF5MDNqZ2kzcQ==" />
            <SocialIcon path={ICONS.facebook} delay={0.5} href="https://www.facebook.com/profile.php?id=100057494506214&rdid=q6Gz21FDs14tuF7h&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1BLHgAyWv4%2F#" />
            <SocialIcon path={ICONS.twitter} delay={0.3} href="https://x.com/Bhumik_sorthiya" />
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-slate-500 font-light tracking-wide">
            © 2026 Bhoomik Sorathiya. All Rights Reserved.
          </p>
        </motion.div>
